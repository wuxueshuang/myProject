  ...
  methods: {
    ...
    play() {      
      if (this.$store.state.playState === true) {
        ...
        // 改变当前所播放的音乐在listdata数据里的isPlay状态
        ...
        // this.$store.commit('sendMusic',this.$store.state.musicList[0])
      ...
      //   console.log('没有歌词，第一次获取歌词')
      //   setTimeout(function() {
      //     console.log(_this.$store.state.currentLyric,'_this.$store.state.currentLyric')
      //     _this.currentLyric = _this.$store.state.currentLyric;
      //     _this.currentLyric.togglePlay();
      //   },3000);
      // }else{
        // console.log('有歌词，获取歌词')
        // this.currentLyric = this.$store.state.currentLyric;
        // getCurrentLyric.togglePlay();
      // }    
